...
<body>
    ...
    <header class="bg-gray-dark sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <a href="index.html" class="flex items-center">
              <div>
                  <img src="storage/images/template-white-logo.png" class="h-24 rounded">
            ...
            <div class="hidden lg:flex items-center space-x-4 relative">
              ...
              <div class="relative group cart-wrapper">
                  <a href="/cart.html" >
                      <img src="storage/images/cart-shopping.svg" alt="Cart" class="h-6 w-6 group-hover:scale-120">
                  </a>
                  <!-- Cart dropdown -->
                      ...
                      <div class="space-y-4">
                          ...
                          <div class="flex items-center justify-between pb-4 border-b border-gray-line">
                              <div class="flex items-center">
                                  <img src="storage/images/single-product/1.jpg" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                  <div>
                          ...
                          <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <img src="storage/images/single-product/2.jpg" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                <div>
              ...
              <a id="search-icon" href="javascript:void(0);" class="text-white hover:text-secondary group">
                  <img src="storage/images/search-icon.svg" alt="Search"
    ...
    <section id="latest-products" class="py-10">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="storage/images/products/5.jpg" alt="Product 1" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="storage/images/products/6.jpg" alt="Product 2" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="storage/images/products/7.jpg" alt="Product 3" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="storage/images/products/8.jpg" alt="Product 4" class="w-full object-cover mb-4 rounded-lg">
    ...
    <section id="banner" class="relative my-16">
        <div class="container mx-auto px-4 py-20 rounded-lg relative bg-cover bg-center" style="background-image: url('storage/images/banner1.jpg');">
        ...
        <div class="container mx-auto px-4 py-10">
          <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-1/6 px-4 mb-8">
              ...
              <ul>
                <li class="flex items-center mb-2">
                  <img src="storage/images/social_icons/facebook.svg" alt="Facebook" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Facebook</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="storage/images/social_icons/twitter.svg" alt="Twitter" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Twitter</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="storage/images/social_icons/instagram.svg" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Instagram</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="storage/images/social_icons/pinterest.svg" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Pinterest</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="storage/images/social_icons/youtube.svg" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
            ...
            <div class="w-full sm:w-2/6 px-4 mb-8">
              ...
              <p><img src="storage/images/template-logo.png" alt="Logo" class="h-[60px] mb-4"></p>
