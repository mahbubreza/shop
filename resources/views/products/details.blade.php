                        ...
                        <div class="grid gap-4">
                            ...
                            <div id="main-image-container">
                                <img id="main-image"
                                    ...
                                    src="{{ asset('storage/images/products/1.jpg') }}"
                            ...
                            <div class="grid grid-cols-5 gap-4">
                                ...
                                <div>
                                    ...
                                    src="{{ asset('storage/images/products/2.jpg') }}"
                                    class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                    alt="Gallery Image 2" />
                                </div>
                                <div>
                                    ...
                                    src="{{ asset('storage/images/products/3.jpg') }}"
                                    class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                    alt="Gallery Image 3" />
                                </div>
                                <div>
                                    ...
                                    src="{{ asset('storage/images/products/4.jpg') }}"
                                    class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                    alt="Gallery Image 4" />
                                </div>
                                <div>
                                    ...
                                    src="{{ asset('storage/images/products/5jpg') }}"
                                    class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                    alt="Gallery Image 5" />
                                </div>
                            </div>
